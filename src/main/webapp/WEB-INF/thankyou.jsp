...
<body>
	<div id = "wrapper">
        ...
        <div id = "main">
			<h2>Thanks for shopping at EKart! An amount of $<fmt:formatNumber type="number" maxFractionDigits="2" minFractionDigits="2" 
	        value="${total}"/> has been charged to your credit card. 
			We hope to see you again soon!</h2><br/>
			
			<h4>Recommended Products:</h4><br/><br/>
